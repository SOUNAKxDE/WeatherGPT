...
const INDIA_CITIES = {"Andhra Pradesh": ["Visakhapatnam", "Vijayawada", "Guntur", "Nellore", "Kurnool", "Kadapa", "Kakinada", "Rajahmundry", "Tirupati", "Anantapur", "Chittoor", "Eluru", "Ongole", "Machilipatnam", "Srikakulam", "Vizianagaram", "Proddatur", "Nandyal", "Adoni", "Tenali", "Amaravati", "Chilakaluripet", "Hindupur", "Madanapalle", "Bhimavaram"], "Arunachal Pradesh": ["Itanagar", "Naharlagun", "Pasighat", "Tawang", "Ziro", "Bomdila", "Aalo", "Tezu", "Changlang", "Khonsa", "Roing", "Yingkiong", "Namsai", "Seppa"], "Assam": ["Guwahati", "Dibrugarh", "Silchar", "Jorhat", "Nagaon", "Tinsukia", "Tezpur", "Bongaigaon", "Sivasagar", "Karimganj", "Goalpara", "Barpeta", "Diphu", "North Lakhimpur", "Dhubri", "Golaghat", "Hailakandi", "Nalbari", "Mangaldoi", "Kokrajhar"], "Bihar": ["Patna", "Gaya", "Bhagalpur", "Muzaffarpur", "Darbhanga", "Purnia", "Ara", "Begusarai", "Katihar", "Munger", "Chhapra", "Bettiah", "Motihari", "Saharsa", "Sasaram", "Hajipur", "Bihar Sharif", "Siwan", "Buxar", "Nawada", "Jehanabad", "Samastipur", "Madhubani", "Aurangabad", "Kishanganj"], "Chhattisgarh": ["Raipur", "Bhilai", "Bilaspur", "Korba", "Durg", "Rajnandgaon", "Jagdalpur", "Raigarh", "Ambikapur", "Dhamtari", "Mahasamund", "Kanker", "Kawardha", "Champa", "Chirmiri", "Bhatapara"], "Goa": ["Panaji", "Margao", "Vasco da Gama", "Mapusa", "Ponda", "Bicholim", "Curchorem", "Cuncolim", "Canacona", "Valpoi"], "Gujarat": ["Ahmedabad", "Surat", "Vadodara", "Rajkot", "Bhavnagar", "Jamnagar", "Junagadh", "Gandhinagar", "Anand", "Nadiad", "Mehsana", "Bharuch", "Navsari", "Morbi", "Surendranagar", "Porbandar", "Gandhidham", "Valsad", "Vapi", "Palanpur", "Godhra", "Patan", "Amreli", "Botad", "Veraval"], "Haryana": ["Faridabad", "Gurugram", "Panipat", "Ambala", "Yamunanagar", "Rohtak", "Hisar", "Karnal", "Sonipat", "Panchkula", "Bhiwani", "Sirsa", "Jind", "Kaithal", "Kurukshetra", "Rewari", "Palwal", "Fatehabad", "Jhajjar", "Mahendragarh", "Narnaul"], "Himachal Pradesh": ["Shimla", "Dharamshala", "Solan", "Mandi", "Kullu", "Manali", "Una", "Bilaspur", "Hamirpur", "Chamba", "Kangra", "Nahan", "Sundernagar", "Palampur", "Nalagarh"], "Jharkhand": ["Ranchi", "Jamshedpur", "Dhanbad", "Bokaro Steel City", "Deoghar", "Hazaribagh", "Giridih", "Ramgarh", "Medininagar", "Phusro", "Chaibasa", "Dumka", "Gumla", "Godda", "Chatra"], "Karnataka": ["Bengaluru", "Mysuru", "Hubballi-Dharwad", "Mangaluru", "Belagavi", "Kalaburagi", "Ballari", "Vijayapura", "Shivamogga", "Tumakuru", "Davanagere", "Bidar", "Hassan", "Udupi", "Chikkamagaluru", "Bagalkot", "Raichur", "Gadag", "Chitradurga", "Kolar", "Mandya", "Robertsonpet", "Karwar"], "Kerala": ["Thiruvananthapuram", "Kochi", "Kozhikode", "Thrissur", "Kollam", "Kannur", "Alappuzha", "Palakkad", "Malappuram", "Kottayam", "Kasaragod", "Pathanamthitta", "Idukki", "Wayanad", "Ernakulam"], "Madhya Pradesh": ["Bhopal", "Indore", "Jabalpur", "Gwalior", "Ujjain", "Sagar", "Dewas", "Satna", "Ratlam", "Rewa", "Katni", "Singrauli", "Burhanpur", "Khandwa", "Bhind", "Chhindwara", "Guna", "Shivpuri", "Vidisha", "Damoh", "Mandsaur", "Khargone", "Neemuch", "Narmadapuram", "Itarsi", "Sehore", "Betul", "Seoni", "Balaghat", "Shahdol", "Panna"], "Maharashtra": ["Mumbai", "Pune", "Nagpur", "Thane", "Nashik", "Chhatrapati Sambhajinagar", "Solapur", "Kolhapur", "Amravati", "Nanded", "Sangli", "Akola", "Latur", "Dhule", "Ahmednagar", "Chandrapur", "Jalgaon", "Bhiwandi", "Malegaon", "Ichalkaranji", "Parbhani", "Jalna", "Satara", "Beed", "Yavatmal", "Wardha", "Dharashiv", "Gondia", "Ratnagiri", "Sindhudurg", "Palghar", "Raigad", "Buldhana", "Washim", "Nandurbar", "Gadchiroli", "Hingoli"], "Manipur": ["Imphal", "Thoubal", "Bishnupur", "Churachandpur", "Kakching", "Ukhrul", "Senapati", "Tamenglong", "Jiribam", "Chandel"], "Meghalaya": ["Shillong", "Tura", "Jowai", "Nongstoin", "Baghmara", "Williamnagar", "Nongpoh", "Mawkyrwat", "Resubelpara"], "Mizoram": ["Aizawl", "Lunglei", "Champhai", "Serchhip", "Kolasib", "Lawngtlai", "Saiha", "Mamit", "Khawzawl", "Saitual"], "Nagaland": ["Kohima", "Dimapur", "Mokokchung", "Tuensang", "Wokha", "Zunheboto", "Phek", "Mon", "Peren", "Kiphire", "Longleng", "Noklak"], "Odisha": ["Bhubaneswar", "Cuttack", "Rourkela", "Berhampur", "Sambalpur", "Puri", "Balasore", "Bhadrak", "Baripada", "Jharsuguda", "Angul", "Jeypore", "Rayagada", "Koraput", "Bargarh", "Kendrapara", "Dhenkanal", "Jajpur", "Keonjhar", "Nabarangpur", "Nayagarh", "Phulbani", "Sundargarh", "Kalahandi"], "Punjab": ["Ludhiana", "Amritsar", "Jalandhar", "Patiala", "Bathinda", "Mohali", "Hoshiarpur", "Batala", "Pathankot", "Moga", "Abohar", "Malerkotla", "Khanna", "Phagwara", "Muktsar", "Barnala", "Rajpura", "Firozpur", "Kapurthala", "Faridkot", "Sangrur", "Fazilka", "Gurdaspur", "Nawanshahr", "Mansa", "Tarn Taran"], "Rajasthan": ["Jaipur", "Jodhpur", "Udaipur", "Kota", "Bikaner", "Ajmer", "Bhilwara", "Alwar", "Bharatpur", "Sikar", "Pali", "Sri Ganganagar", "Kishangarh", "Baran", "Dholpur", "Tonk", "Beawar", "Hanumangarh", "Chittorgarh", "Nagaur", "Churu", "Jhunjhunu", "Sawai Madhopur", "Jaisalmer", "Barmer", "Banswara", "Dungarpur", "Sirohi", "Jalore", "Rajsamand", "Karauli", "Pratapgarh"], "Sikkim": ["Gangtok", "Namchi", "Gyalshing", "Mangan", "Rangpo", "Jorethang", "Singtam"], "Tamil Nadu": ["Chennai", "Coimbatore", "Madurai", "Tiruchirappalli", "Salem", "Tirunelveli", "Tiruppur", "Vellore", "Erode", "Thoothukudi", "Dindigul", "Thanjavur", "Ranipet", "Sivakasi", "Karur", "Udhagamandalam", "Hosur", "Nagercoil", "Kanchipuram", "Kumbakonam", "Cuddalore", "Tiruvannamalai", "Pollachi", "Rajapalayam", "Namakkal", "Pudukkottai", "Karaikudi", "Nagapattinam", "Ramanathapuram", "Virudhunagar", "Krishnagiri", "Ariyalur", "Perambalur", "Sivaganga", "Theni"], "Telangana": ["Hyderabad", "Warangal", "Nizamabad", "Karimnagar", "Khammam", "Ramagundam", "Mahbubnagar", "Nalgonda", "Adilabad", "Suryapet", "Miryalaguda", "Siddipet", "Jagtial", "Mancherial", "Kamareddy", "Sangareddy", "Medak", "Bhongir", "Wanaparthy", "Vikarabad", "Jangaon"], "Tripura": ["Agartala", "Udaipur", "Dharmanagar", "Kailashahar", "Belonia", "Khowai", "Ambassa", "Kamalpur", "Sabroom", "Sonamura"], "Uttar Pradesh": ["Lucknow", "Kanpur", "Ghaziabad", "Agra", "Varanasi", "Meerut", "Prayagraj", "Bareilly", "Aligarh", "Moradabad", "Saharanpur", "Gorakhpur", "Noida", "Firozabad", "Jhansi", "Muzaffarnagar", "Mathura", "Rampur", "Shahjahanpur", "Farrukhabad", "Ayodhya", "Mau", "Hapur", "Etawah", "Mirzapur", "Bulandshahr", "Sitapur", "Hardoi", "Fatehpur", "Raebareli", "Orai", "Sultanpur", "Azamgarh", "Bijnor", "Budaun", "Basti", "Ballia", "Deoria", "Ghazipur", "Jaunpur", "Lakhimpur", "Pilibhit", "Unnao", "Banda", "Amroha", "Hathras", "Kasganj", "Chandausi", "Greater Noida"], "Uttarakhand": ["Dehradun", "Haridwar", "Roorkee", "Haldwani", "Rudrapur", "Kashipur", "Rishikesh", "Nainital", "Almora", "Pithoragarh", "Pauri", "Srinagar", "Tehri", "Uttarkashi", "Champawat", "Bageshwar", "Kotdwar", "Ramnagar"], "West Bengal": ["Kolkata", "Asansol", "Siliguri", "Durgapur", "Bardhaman", "Malda", "Baharampur", "Habra", "Kharagpur", "Shantipur", "Dankuni", "Ranaghat", "Haldia", "Raiganj", "Krishnanagar", "Nabadwip", "Medinipur", "Jalpaiguri", "Balurghat", "Basirhat", "Bankura", "Chakdaha", "Darjeeling", "Alipurduar", "Cooch Behar", "Purulia", "Kalimpong", "Jhargram", "Bolpur", "Suri", "Tamluk", "Contai"], "Andaman and Nicobar Islands": ["Port Blair", "Diglipur", "Mayabunder", "Rangat", "Car Nicobar", "Hut Bay"], "Chandigarh": ["Chandigarh"], "Dadra and Nagar Haveli and Daman and Diu": ["Silvassa", "Daman", "Diu"], "Delhi": ["New Delhi", "Central Delhi", "North Delhi", "North East Delhi", "North West Delhi", "East Delhi", "South Delhi", "South East Delhi", "South West Delhi", "West Delhi", "Shahdara"], "Jammu and Kashmir": ["Srinagar", "Jammu", "Anantnag", "Baramulla", "Sopore", "Kathua", "Udhampur", "Poonch", "Rajouri", "Kupwara", "Pulwama", "Kulgam", "Budgam", "Bandipora", "Ganderbal", "Doda", "Kishtwar", "Ramban", "Reasi", "Samba", "Shopian"], "Ladakh": ["Leh", "Kargil"], "Lakshadweep": ["Kavaratti", "Agatti", "Amini", "Andrott", "Minicoy", "Kalpeni"], "Puducherry": ["Puducherry", "Karaikal", "Yanam", "Mahe"]};
